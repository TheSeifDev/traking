    ...
    <div className="min-h-full bg-[#08081f] px-4 py-6 sm:px-6 lg:px-8 lg:py-8">
      <div className="mx-auto max-w-[1200px] space-y-7">
        ...
        <section>
          ...
          {hiddenLegacySpaces > 0 && <p className="mt-3 text-xs leading-5 text-amber-200/65">{hiddenLegacySpaces} historical workspace container is preserved for existing data and omitted from the normal child-Space directory until it is mapped to a real ClickUp Space.</p>}
        </section>
      </div>
    </div>
  );
