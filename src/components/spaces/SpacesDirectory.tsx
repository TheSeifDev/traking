...
export default function SpacesDirectory({ spaces, organizations, role, activeSpaceId }: { spaces: AccessibleSpace[]; organizations: AccessibleOrganization[]; role: UserRole; activeSpaceId: string | null }) {
